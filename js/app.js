...
/// create new array called 'bondTitles' with only the titles of the Bond films
// bondFilms.push({bondTitles: ); 
let bondTitles = [];
...
/// create a new array 'oddBonds', of only the Bonds films released on odd-numbered years
let oddBonds = [];
for (i = 0; i < bondFilms.length; i++) {
